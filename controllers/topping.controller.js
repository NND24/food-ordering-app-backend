...
const getStoreToppings = asyncHandler(async (req, res, next) => {
  try {
    ...
    const toppings = await ToppingGroup.find({ store: store_id }).populate({
      path: "toppings",
      select: "name price",
    });
...
const getDishToppings = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json(successResponse(cleanedToppingGroups, "Toppings retrieved successfully"));
});
...
const getToppingById = asyncHandler(async (req, res, next) => {
  ...
  const topping = await Topping.findById(topping_id).select("name price description").populate("store", "name");
...
const getToppingGroupById = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json(successResponse(toppingGroup, "Topping group retrieved successfully"));
});
...
const createToppingGroup = asyncHandler(async (req, res, next) => {
  ...
  res.status(201).json(successResponse(filteredResult, "Topping group created successfully"));
});
...
const createToppingInGroup = asyncHandler(async (req, res, next) => {
  ...
  res.status(201).json(successResponse(filteredResult, "Topping created successfully"));
});
...
const updateToppingInGroup = asyncHandler(async (req, res, next) => {
  ...
  res.status(200).json(successResponse(null, "Topping updated successfully"));
});
